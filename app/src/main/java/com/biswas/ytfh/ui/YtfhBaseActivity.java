...
public abstract class YtfhBaseActivity extends AppCompatActivity {

    Toolbar toolbar;
    YtfhTextView tvTitle;

    public YtfhApplication mApp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.activity_ytfh_base);

        mApp = (YtfhApplication) getApplicationContext();
        mActivity = this;
